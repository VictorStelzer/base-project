...
/** HoverProps do Paper — suporta shadow, bg, color, border e scale. */
export interface HoverProps extends Pick<BaseHoverProps, 'shadow' | 'bg' | 'color' | 'borderColor' | 'borderWidth' | 'scale' | 'opacity'> {}
 ...
 */
export interface Props extends Omit<PaperProps, ConflictingProps>, SpacingProps, SizeProps, FlexProps, RadiusProps {
